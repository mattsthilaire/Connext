"""
Django settings for connext project.
...
SECRET_KEY = "django-insecure-%g8um)_a^att1$w*lyj1z9i3@ytrvupid^mxqn&4wz-=-s^=3="
...
WSGI_APPLICATION = "connext.wsgi.application"
...
load_dotenv() # load in env variables. In the future, we'll have this be more robust
...
MEDIA_URL = f"https://{AWS_S3_CUSTOM_DOMAIN}/users/"

class UserMediaStorage(S3Boto3Storage):
    location = "users"
    file_overwrite = False

# Use ManifestStaticFilesStorage for static files
